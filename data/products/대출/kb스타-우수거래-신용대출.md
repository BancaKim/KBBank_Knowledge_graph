...
channels:
- 스타뱅킹
page_url: https://obank.kbstar.com/quics?page=C103429&cc=b061496:b061645&isNew=N&prcode=LN20001401
page_id: C103429
scraped_at: '2026-03-23T13:48:43'
...
KB 국민은행과 거래하는 STAR CLUB 베스트 등급 이상 고객에게 거래실적 우대 추가 한도를 제공하는 비대면 전용 신용대출 상품
...
원(리)금균등분할상환 : 1년 이상 10년 이내(거치기간 미운영)

## 상품안내

### 대출금리

일시상환방식(일반자금대출), 대출기간 2년미만, 신용등급3등급기준, VVIP기준

### 조기상환수수료

(종합통장자동대출은 제외)중도상환수수료 : 중도상환원금 × 수수료율(0.11%) × 잔존일수 ÷ 대출기간(최장 3년까지 부과)
...
공공마이데이터 실패 등의 사유로 직장/소득정보가 정상 확인되지 않는 경우에는 추가 서류 제출이 필요할 수 있습니다.
...
금리재산정주기 도래 또는 기한연장 시 거래실적에 따른 우대금리 조건 충족여부, KB STAR CLUB 등급 및 신용등급 변화 등에 따라 금리가 변동될 수 있습니다.
...
공공마이데터로 재직·소득 증빙서류 수집 시 별도 제출서류 없음 
     ※ 단, 사업자의 경우 과세표준확정신고 및 납부계산서 사진촬영 제출
...
CD 91일물 | 2.83 | 2.16 | 0.90 | 4.09 | 4.99
금융채6개월 | 2.84 | 2.15 | 0.90 | 4.09 | 4.99
금융채12개월 | 2.98 | 2.12 | 0.90 | 4.20 | 5.10
