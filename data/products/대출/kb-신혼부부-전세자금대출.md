...
channels:
- 영업점
page_url: https://obank.kbstar.com/quics?page=C103429&cc=b061496:b061645&isNew=N&prcode=LN20000166
page_id: C103429
scraped_at: '2026-03-23T13:53:41'
term: 최장 2년
eligibility_summary: '혼인기간 7년 이내 신혼부부 또는 3개월 이내 결혼예정자로서 아래 내용을 모두 충족하는 민법상 성년인 세대주
  또는 세대주로 인정되는 고객
...
인터넷대출시행,변경전,변경후, 기존고객적용여부
        ...
        * 본인과 배우자(결혼예정자포함)가 합산한 주택보유수가 무주택 또는 1주택(부부합산소득 1억원이하)이내인 고객(주택보유수가 1주택인 경우 보유주택가액이 9억원 초과하는 주택이거나, 2020.7.10일이후 투기지역 또는 투기과열지구 내 취득시점 시가 3억원 초과 아파트를 구입한 경우는 제외)           
        ...
        대출상환방법(2020.10.30)
        * 일시상환  * 혼합상환(일시상환+원(리)금균등 분할상환): 분할상환금액은 대출금액의 10%,20%,30%중 선택
...
대출상환방법(2020.10.30) | * 일시상환  * 혼합상환(일시상환+원(리)금균등 분할상환): 분할상환금액은 대출금액의 10%,20%,30%중 선택 | * 일시상환  * 혼합상환 (원(리)금균등 분할상환+일시상환): 분할상환금액은 대출금액의 5%이상(단, 일시상환금액은 최소 10만원이상, 원단위) | 적용
