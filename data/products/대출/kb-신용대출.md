...
channels:
- 영업점
page_url: https://obank.kbstar.com/quics?page=C103429&cc=b061496:b061645&isNew=N&prcode=LN20001391
page_id: C103429
scraped_at: '2026-03-23T13:47:26'
term: 최장 10년
eligibility_summary: "당행 개인신용평가시스템(CSS)에 의해 대출적격자로 판정된 고객으로 각 직군별 재직기간  \n기준을 충족하고,\
  \ 소득증빙 가능한 직장인 고객 \n☞ 건강보험 자격득실확인서로 재직확인이 가능한 근로소득자만 대상으로 함"
---
...
‘직장인’ 대상 대면전용 통합 신용대출 상품
당행 협약기관 임직원은 추가 우대금리 제공됩니다.

## 대출신청자격

당행 개인신용평가시스템(CSS)에 의해 대출적격자로 판정된 고객으로 각 직군별 재직기간  
기준을 충족하고, 소득증빙 가능한 직장인 고객 
☞ 건강보험 자격득실확인서로 재직확인이 가능한 근로소득자만 대상으로 함

## 대출금액

최대 3.5억원 이내(단, 재직기간 1년미만인 경우 최대 1억원 이내)
- 종합통장자동대출은 최대 1.5억원 이내 
※ “최종”대출한도는 신용평가 결과에 따라 차등 적용됩니다.

## 대출기간 및 상환 방법

일시상환(종합통장자동대출 포함) : 1년(최장 10년까지 기한연장 가능)
원(리)금균등분할상환 : 1년 이상 10년 이내
 - 대출기간의 30% 범위 내에서 최장 12개월까지 거치기간 운용 가능
     - 거치기간 변경 불가하며 거치기간 종료는 거치기간 중 가능
...
단, 금리변동주기 또는 고정금리기간이 3년 이상이거나 금리변동주기와 대출기간이 동일한 경우 수수료율(0.18%) 적용
...
☞ 분할상환금(또는 분할상환원리금)을 상환하여야 할 날의 다음날부터는 해당 분할상환금(또는 분할상환원리금)에 대한 연체이자를, 2회이상 연속하여 지체한 때에는 기한 이익상실로 인하여 대출잔액에 대한 연체이자를 내셔야 합니다.
...
CD 91일물 | 2.83 | 2.37 | 1.00 | 4.20 | 5.20
금융채6개월 | 2.84 | 2.36 | 1.00 | 4.20 | 5.20
금융채12개월 | 2.98 | 2.33 | 1.00 | 4.31 | 5.31
